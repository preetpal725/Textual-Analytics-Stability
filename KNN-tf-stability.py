...
ab=data.Sentences.shape

#put the text to integer
lbl_enc = preprocessing.LabelEncoder()
y = lbl_enc.fit_transform(data.Classification.values)
#randome split the data
...
tfv = NumberNormalizingVectorizer(min_df=3,  
                                  ...
                                  use_idf=True,
                                  smooth_idf=True)
#using tf-idf to fit the training dataset and test dataset
